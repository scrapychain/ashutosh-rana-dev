...
export default function SocialCard({
  ...
  return (
    <aside className="w-full border border-emerald-500/25 bg-emerald-500/5 p-5 shadow-[0_0_35px_rgba(16,185,129,0.07)]">
      <div className="text-[11px] tracking-[0.25em] text-emerald-300/80">&gt; {meta.header}</div>

      <div className="mt-5 flex items-center gap-3">
        <span
          aria-hidden
          className="inline-flex h-11 w-11 shrink-0 items-center justify-center border border-emerald-400/30 bg-black/50 text-emerald-200"
        >
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="mt-5 inline-flex w-full items-center justify-center gap-2 border border-emerald-400/40 px-4 py-2.5 text-sm tracking-widest text-emerald-200 transition hover:border-emerald-300 hover:bg-emerald-500/10 hover:text-emerald-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-300/50"
      >
        {meta.cta}
